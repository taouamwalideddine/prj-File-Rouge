...
<div class="container mx-auto px-4 py-8">
    @if(isset($isApproved) && !$isApproved)
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Your Teacher Account is Pending Approval</h2>
            <p class="text-gray-600 mb-6">Our admin team is reviewing your application. You'll gain full access to all teacher features once approved.</p>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            Approval typically takes 1-2 business days. You'll receive an email notification when your account is approved.
                        </p>
                    </div>
                </div>
            </div>
